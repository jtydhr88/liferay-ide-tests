...
import com.liferay.ide.project.ui.tests.page.ImportLiferayModuleProjectPO;
...
public class ImportLiferayModuleProjectTests extends SWTBotBase implements ImportLiferayModuleProject
{
    ...
    public void importASingleModule()
    {
        ...
        projectTree.expandNode( "ServicebuilderModule" ).doubleClick( "settings.gradle" );
        ...
        projectTree.expandNode( "ServicebuilderModule-api" ).doubleClick( "build.gradle" );
        ...
        projectTree.expandNode( "ServicebuilderModule-service" ).doubleClick( "build.gradle" );
        sleep( 200 );
